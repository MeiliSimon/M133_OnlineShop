...
!function (e, t) {
    ...
    var e,
      ...
      Q = {
        ...
        needsContext: new RegExp(
          "^" + R + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + R +
            "*((?:-\\d)?\\d*)" + R + "*\\)|)(?=[^-]|$)",
          "i",
        ),
      },
      ...
      if (!r && (C(e), e = e || T, E)) {
        if (11 !== d && (u = Z.exec(t))) {
          if (i = u[1]) {
            ...
            if (
              (i = u[3]) && p.getElementsByClassName && e.getElementsByClassName
            ) {
        ...
        if (
          ...
          if (c = t, f = e, 1 === d && (U.test(t) || _.test(t))) {
            ...
            ((s = e.getAttribute("id"))
              ? s = s.replace(re, ie)
              : e.setAttribute("id", s = A)), o = (l = h(t)).length;
    ...
    for (
      e in p = se.support = {},
          ...
          return r != T && 9 === r.nodeType && r.documentElement &&
            (a = (T = r).documentElement,
              ...
              (p.qsa = J.test(T.querySelectorAll)) && (ce(function (e) {
                var t;
                a.appendChild(e).innerHTML = "<a id='" + A +
                  "'></a><select id='" + A +
        ...
        se.matchesSelector = function (e, t) {
          if (
            C(e),
              p.matchesSelector && E && !k[t + " "] && (!s || !s.test(t)) &&
              (!v || !v.test(t))
          ) {
            try {
              var n = c.call(e, t);
        ...
        se.attr = function (e, t) {
          ...
          var n = x.attrHandle[t.toLowerCase()],
            ...
            : void 0;
          return void 0 !== r ? r : p.attributes || !E
            ? e.getAttribute(t)
      ...
      g = se.select = function (e, t, n, r) {
        ...
        if (n = n || [], 1 === c.length) {
          if (
            ...
            9 === t.nodeType && E && x.relative[o[1].type]
          ) {
            if (
  ...
  (E.fn.init = function (e, t, n) {
    ...
    if (n = n || L, "string" == typeof e) {
      ...
      return (i = w.getElementById(r[2])) && (this[0] = i, this.length = 1),
        this;
    }
    return e.nodeType
      ? (this[0] = e, this.length = 1, this)
      : b(e)
      ? void 0 !== n.ready ? n.ready(e) : e(E)
      : E.makeArray(e, this);
  ...
  function B(e, t, n, r) {
    var i;
    try {
      e && b(i = e.promise) ? i.call(e).done(t).fail(n)
  ...
  E.Deferred.exceptionHook = function (e, t) {
    g.console && g.console.warn && e && M.test(e.name) &&
    ...
    E.extend({
      ...
      ready: function (e) {
        (!0 === e ? --E.readyWait : E.isReady) ||
          (E.isReady = !0) !== e && 0 < --E.readyWait || W.resolveWith(w, [E]);
      },
    }),
    E.ready.then = W.then,
    ...
    Q.prototype = {
      ...
      remove: function (e, t) {
        ...
        if (void 0 !== r) {
          ...
          (void 0 === t || E.isEmptyObject(r)) && (e.nodeType
    ...
    E.fn.extend({
      queue: function (t, n) {
        ...
        return "string" != typeof t && (n = t, t = "fx", e--),
          arguments.length < e ? E.queue(this[0], t) : void 0 === n
            ? this
            : this.each(function () {
  ...
  E.event = {
        ...
        for (; l !== this; l = l.parentNode || this) {
          if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
            for (o = [], a = {}, n = 0; n < u; n++) {
              ...
              (a[i] = r.needsContext
                ? -1 < E(i, this).index(l)
                : E.find(i, this, null, [l]).length), a[i] && o.push(r);
            }
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return fe.test(t.type) && t.click && S(t, "input") &&
            Ne(t, "click", Ce),
            !1;
        },
        trigger: function (e) {
    ...
    if (
      ...
      if (s) {
        for (
          ...
          u = a[c],
            pe.test(u.type || "") && !Y.access(u, "globalEval") &&
            E.contains(l, u) &&
            (u.src && "module" !== (u.type || "").toLowerCase()
              ? E._evalUrl && !u.noModule &&
                E._evalUrl(
                  u.src,
  ...
  E.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        !(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType ||
          E.isXMLDoc(e))
      ) {
  ...
  function We(e, t, n) {
    ...
    return (n = n || Re(e)) &&
      ("" !== (a = n.getPropertyValue(t) || n[t]) || ie(e) ||
        (a = E.style(e, t)),
        !m.pixelBoxStyles() && Ie.test(a) && Me.test(t) &&
        (r = s.width,
          i = s.minWidth,
          o = s.maxWidth,
  ...
  function et(e, t, n) {
    ...
    return (!m.boxSizingReliable() && i ||
      !m.reliableTrDimensions() && S(e, "tr") || "auto" === a ||
  ...
  E.extend({
      ...
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        (n = function (e, t, n, r) {
          var i,
            ...
            c = e.nodeType && (E.cssNumber[t] || "px" !== l && +u) &&
              te.exec(E.css(e, t));
          if (c && c[3] !== l) {
            u /= 2, l = l || c[3], c = +u || 1;
            while (a--) {
          ...
          ("number" !== o || u ||
            ...
            m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") ||
            (l[t] = "inherit"),
    ...
    css: function (e, t, n, r) {
      ...
      return Ye.test(t) || (t = Ue(s)),
        (a = E.cssHooks[t] || E.cssHooks[s]) && "get" in a &&
        (i = a.get(e, !0, n)),
        void 0 === i && (i = We(e, t, r)),
          ...
          this.each(function (e) {
            ...
            1 === this.nodeType &&
              (null == (t = i ? n.call(this, e, E(this).val()) : n)
                ...
                : "number" == typeof t
                ? t += ""
                : Array.isArray(t) && (t = E.map(t, function (e) {
                  return null == e ? "" : e + "";
                })),
      ...
      if (
        o = f = a = n = n || w,
          ...
          (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(), h.sort()),
            u = p.indexOf(":") < 0 && "on" + p,
            (e = e[E.expando] ? e : new E.Event(p, "object" == typeof e && e))
              .isTrigger = r ? 2 : 3,
            e.namespace = h.join("."),
        ...
        return e.type = p,
          ...
          c._default && !1 !== c._default.apply(d.pop(), t) || !X(n) ||
          u && b(n[p]) && !x(n) &&
            ((a = n[u]) && (n[u] = null),
              E.event.triggered = p,
    ...
    E.fn.extend({
      ...
      serializeArray: function () {
        return this.map(function () {
          ...
          var e = this.type;
          return this.name && !E(this).is(":disabled") &&
            gt.test(this.nodeName) && !ht.test(e) &&
